...
int i2c3_master_transmit(uint16_t addr, uint8_t *data, uint16_t length, uint32_t timeout)
{
	...
	status = HAL_I2C_Master_Transmit(&I2cHandle3, addr, data, length, timeout);
	if(status != HAL_OK) {
		I2C3_Error();
	}
	return status;
...
{
	HAL_StatusTypeDef status = HAL_OK;
	status = HAL_I2C_Master_Receive(&I2cHandle3, addr, data, length, timeout);
	if(status != HAL_OK) {
		I2C3_Error();
	}
	return status;
...
{
	HAL_StatusTypeDef status = HAL_OK;
	status = HAL_I2C_Mem_Write(&I2cHandle3, addr, reg, I2C3_REG_BIT, data, length, timeout);
	if(status != HAL_OK) {
		I2C3_Error();
	}
	return status;
...
{
	HAL_StatusTypeDef status = HAL_OK;
	status = HAL_I2C_Mem_Read(&I2cHandle3, addr, reg, I2C3_REG_BIT, data, length, timeout);
	if(status != HAL_OK) {
		I2C3_Error();
	}
	return status;
...
{
	HAL_StatusTypeDef status = HAL_OK;
	status = HAL_I2C_Mem_Write_IT(&I2cHandle3, addr, reg, I2C3_REG_BIT, data, length);
	if(status != HAL_OK) {
		I2C3_Error();
	}
	return status;
...
{
	HAL_StatusTypeDef status = HAL_OK;
	status = HAL_I2C_Mem_Read_IT(&I2cHandle3, addr, reg, I2C3_REG_BIT, data, length);
	if(status != HAL_OK) {
		I2C3_Error();
	}
	return status;
...
{
	HAL_StatusTypeDef status = HAL_OK;
	status = HAL_I2C_Mem_Write_DMA(&I2cHandle3, addr, reg, I2C3_REG_BIT, data, length);
	if(status != HAL_OK) {
		I2C3_Error();
	}
	return status;
...
{
	HAL_StatusTypeDef status = HAL_OK;
	status = HAL_I2C_Mem_Read_DMA(&I2cHandle3, addr, reg, I2C3_REG_BIT, data, length);
	if(status != HAL_OK) {
		I2C3_Error();
	}
	return status;
